  ...
  return (
    <div className="parent-container">
      <form className="auth-container" onSubmit={handleSubmit}>
        ...
        <input
          className={
            NAME_REGEX.test(surname) ? "auth-input valid" : "auth-input"
          }
          type="text"
          placeholder="Surname"
          value={surname}
        ...
        <input
          className={
            LOGIN_REGEX.test(login) ? "auth-input valid" : "auth-input"
          }
          type="text"
          placeholder="Login"
          value={login}
        ...
        <button
          className={isValidInput() ? "submit-btn active" : "submit-btn"}
